...
method_pal <- c(esm2_min_project = "#A8CDECFF", 
                esm2_min_treatment = "#F6955EFF", 
                esm2_mean_project = "#682C37FF", 
                esm2_mean_treatment = "#9B6981FF", 
                fd_fd_fd = "#7887A4FF")
...
```{r fig 3 soc mgmt incremental aov letters}
...
```{r fig s21 dsoc error vs bd error for esm methods}
